...
# Example Usage
pdf_path = "./week-6/session-3-real/exercise-3/example.pdf"  # Replace with your PDF file path
txt_path = "./week-6/session-3-real/exercise-3/example.txt"  # Replace with your text file path
output_pdf = "./week-6/session-3-real/exercise-3/output.pdf"  # Name of the generated PDF
