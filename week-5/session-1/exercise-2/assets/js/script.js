...
const renderRepos = (repos) => {
  ...
  console.log("User Avatar Url:", repos[0].owner.avatar_url);
  console.log("User Login:", repos[0].owner.login);
  repos.forEach((repo) => {
    const pub = repo.private ? "Private" : "Public";
    console.log(`Repo Name: ${repo.full_name}. ${pub}`);
